...
🏁 Ranking – Menos trocas: Selection
🏁 Ranking – Menos comparações: Comb (1.3)
...
🏁 Ranking – Menos trocas: Todos empatados
🏁 Ranking – Menos comparações: Bubble, Cocktail e Gnome

🔸 Vetor 3 (ordem reversa)
Algoritmo	Trocas (swaps)	Interações (comparações)
Bubble	            190             	190
Selection	        10              	190
Cocktail	        190	                190
...
🧠 Análise Comparativa
Situação	Melhor em Trocas	Melhor em Comparações
Vetor aleatório	Selection	Comb (1.3)
Vetor ordenado	Todos (0 swaps)	Bubble/Cocktail/Gnome
Vetor reverso	Selection	Comb (1.3)
...
Gnome Sort: Simples, mas pouco eficiente em cenários desordenados.
 ...
 Referência teórica
 Comb Sort — conforme descrito no material original anexado (PDF comb_sort.pdf), o fator de contração de 1.3 é considerado ótimo para equilibrar desempenho e estabilidade.


             Exemplo de Execução
=== vetor1 ===
Algoritmo     |       Swaps |    Comparacoes
------------- + ------------ + ---------------
Bubble        |           78 |             180
Selection     |           18 |             190
Cocktail      |           78 |             154
